...
export const SITE_TITLE = process.env.NEXT_PUBLIC_SITE_TITLE || "Chasing Studio"
...
const SITE_DOMAIN = process.env.NEXT_PUBLIC_SITE_DOMAIN || VERCEL_PROJECT_URL
...
export const CONFIG_CHECKLIST_STATUS = {
  ...
  hasStorage:
    HAS_VERCEL_BLOB_STORAGE || HAS_CLOUDFLARE_R2_STORAGE || HAS_AWS_S3_STORAGE,

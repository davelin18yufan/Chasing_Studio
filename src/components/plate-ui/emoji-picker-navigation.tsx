...
export function EmojiPickerNavigation({
  ...
  return (
    <nav
      id="emoji-nav"
      className="mb-2.5 border-0 border-b border-solid border-b-gofun p-3"
    >
        ...
        {emojiLibrary
          ...
          .map(({ id }) => (
            <button
              ...
              type="button"
              className={cn(
                "flex grow cursor-pointer items-center justify-center border-none bg-transparent fill-current text-sm text-hai hover:text-gray-800",
                id === focusedCategory &&

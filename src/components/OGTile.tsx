    ...
    >
      ...
      <div
        className={clsx(
          ...
          "bg-gray-50 dark:bg-kachi/50",
          "group-active:bg-gray-50 group-active:dark:bg-kachi/50",
          "group-hover:bg-gofun group-hover:dark:bg-kachi/70",
          "border-t border-shironezumi dark:border-gray-800"
        )}
      >
        <div className="text-gray-800 dark:text-shironeri font-medium">
          {title}
        </div>
